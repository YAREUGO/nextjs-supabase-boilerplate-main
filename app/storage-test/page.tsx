  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-amber-950 dark:to-orange-950">
      <div className="max-w-4xl mx-auto p-8">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            <Gem className="w-8 h-8 text-amber-600 dark:text-amber-400" />
      ...
      <div className="mb-8 p-6 border-2 border-amber-300 dark:border-amber-700 rounded-lg bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/50 dark:to-orange-950/50 shadow-lg">
        <h2 className="text-2xl font-bold mb-4 text-amber-900 dark:text-amber-200 flex items-center gap-2">
        ...
        <div className="flex items-center gap-4">
          <label htmlFor="file-upload" className="cursor-pointer">
            <Button 
              disabled={uploading} 
              className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white border-0 shadow-lg hover:shadow-xl transition-all"
              asChild
            >
              <span>
          ...
          <input
            ...
            className="hidden"
          />
          <p className="text-sm text-amber-700 dark:text-amber-400 font-medium">권장: 6MB 이하 파일</p>
        </div>
      </div>
      ...
      <div className="border-2 border-amber-300 dark:border-amber-700 rounded-lg bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/50 dark:to-orange-950/50 shadow-lg">
        ...
        {loading ? (
          <div className="p-8 text-center text-amber-700 dark:text-amber-400">
            <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-amber-600 dark:border-amber-400"></div>
            <p className="mt-4 font-semibold">파일 목록을 불러오는 중...</p>
          </div>
        ) : files.length === 0 ? (
          <div className="p-8 text-center text-amber-700 dark:text-amber-400">
            <div className="inline-flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-amber-200 to-orange-200 dark:from-amber-800 dark:to-orange-800">
              <LuFile className="w-8 h-8 text-amber-600 dark:text-amber-400" />
            </div>
            <p className="font-semibold">업로드된 파일이 없습니다.</p>
          ...
          <div className="divide-y-2 divide-amber-300 dark:divide-amber-700">
            {files.map((file) => (
              <div
                key={file.id}
                className="p-4 flex items-center justify-between hover:bg-amber-100/50 dark:hover:bg-amber-900/30 transition-colors"
              >
                <div className="flex items-center gap-3 flex-1">
                  <div className="p-2 rounded-lg bg-gradient-to-br from-amber-200 to-orange-200 dark:from-amber-800 dark:to-orange-800">
                    <LuFile className="w-6 h-6 text-amber-700 dark:text-amber-300" />
                  </div>
                  <div>
                    <p className="font-bold text-amber-900 dark:text-amber-200">{file.name}</p>
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    className="border-2 border-red-400 dark:border-red-600 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/50"
                  >
      ...
      {/* 사용자 정보 */}
      <div className="mt-8 p-4 bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/50 dark:to-orange-900/50 rounded-lg border-2 border-amber-300 dark:border-amber-700 shadow-lg">
        <h3 className="font-semibold mb-2 text-amber-900 dark:text-amber-200 flex items-center gap-2">
          <Crown className="w-5 h-5 text-amber-600 dark:text-amber-400" />
          현재 사용자
        </h3>
        <p className="text-sm text-amber-800 dark:text-amber-300">User ID: {user.id}</p>
